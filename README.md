...
This is the **preferred** way to do it, because it is easy to improve and repeat to anybody in the world, as soon as the github repo that contains your maven script is published, everybody can improve it, for example update it to a new version of the source jar.
